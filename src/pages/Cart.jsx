  ...
  return (
    ...
    <div style={{paddingTop:'100px'}} className='px-5'>
      ...
      <div className="grid grid-cols-3 gap-4 mt-5">
        {/* column comes in 3/4 ,so col-span-2 */}
          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product Name</td>
                <td><img width={'70px'} src="https://media.istockphoto.com/id/1461676039/photo/shopping-cart-full-of-groceries-on-yellow-background.jpg?s=612x612&w=0&k=20&c=_Kqnn489g9j7GM3U0ageHAtdnOeUJ8JhWoSVcRjPbSQ=" alt="" /></td>
                <td>
                  <div className='flex'>
