...
const Header = ({insideHome}) => {
  ...
  return (
    ...
    <ul className='flex-1 text-right'>
        { 
        insideHome &&
          <li className='list-none inline-block px-5'><input style={{width:'300px'}} className='rounded p-2 text-black' onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))} type="text" placeholder='search products here' /></li>
        }
        {/* badge */}
